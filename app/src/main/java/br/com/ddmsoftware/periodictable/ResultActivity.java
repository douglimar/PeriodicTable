...
public class ResultActivity extends AppCompatActivity {
    ...
    private void receiveDataFromActivity() {
        ...
        tvResult_info1.setText(aResult[0] + " - " + aResult[1] + " - " + aResult[2]);
        tvResult_info2.setText("Latim Name: " + aResult[3]);
        tvResult_info3.setText("Origin of Name: " + aResult[4]);
        tvResult_info4.setText("Group Name: " + aResult[6]);
